...
<body>
			...
			<ul class="navbar">
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu">
						...
						<li><a href="/mons/leaders.php" class="active">Руководители</a></li>
	...
	<div id="content">
		<div class="container">
			<h1>Руководители</h1>
			<p>Лидеры фракций на сервере</p>

			<div id="monitoring">
				<table class="mon-table">
					<tr>
						<td class="bold nick">1. De_Morgan</td>
						<td class=""><i class="time"></i> Последний заход в 12:42 </td>
						<td class=""><i class="user"></i> Los Santos PD</td>
						<td class="woutline" style="float: right"><i class="online" style="margin-top: 7px"></i></td>
					</tr>
					<tr>
						<td class="bold nick">2. De_Morgan</td>
						<td class=""><i class="time"></i> Последний заход в 12:42 </td>
						<td class=""><i class="user"></i> Varios Los Aztecaz</td>
						<td class="woutline" style="float: right"><i class="online" style="margin-top: 7px"></i></td>
					</tr>
					<tr>
						<td class="bold nick">3. De_Morgan</td>
						<td class=""><i class="time"></i> Последний заход в 12:42 </td>
						<td class=""><i class="user"></i> San Fierro PD</td>
						<td class="woutline" style="float: right"><i class="offline" style="margin-top: 7px"></i></td>
					</tr>
					<tr>
						<td class="bold nick">4. De_Morgan</td>
						<td class=""><i class="time"></i> Последний заход в 12:42 </td>
						<td class=""><i class="user"></i> San Fierro News</td>
						<td class="woutline" style="float: right"><i class="online" style="margin-top: 7px"></i></td>
					</tr>
					<tr>
						<td class="bold nick">5. De_Morgan</td>
						<td class=""><i class="time"></i> Последний заход в 12:42 </td>
						<td class=""><i class="user"></i> San Fierro Army</td>
						<td class="woutline" style="float: right"><i class="offline" style="margin-top: 7px"></i></td>
					</tr>
				</table>
			</div>
